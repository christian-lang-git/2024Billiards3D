...
export const EVENT_FULL_UPDATE = "EVENT_FULL_UPDATE";
...
export const SURFACE_TYPE_CUSTOM = 0;
export const SURFACE_TYPE_ELLIPSOID = 1;
export const SURFACE_TYPE_TORUS = 2;
...
export const TEXTURE_MODE_SPECIALIZED_SINGLE_COLOR = 0;//used
export const TEXTURE_MODE_SPECIALIZED_RETURN_FTLE = 1;//used
export const TEXTURE_MODE_SPECIALIZED_RETURN_POSITION_NORMALIZED = 2;//used
export const TEXTURE_MODE_SPECIALIZED_RETURN_DIRECTION_NORMALIZED = 3;//used
