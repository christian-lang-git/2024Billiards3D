...
class OffscreenSurfaceComputationFlow extends OffscreenSurfaceComputation {
    ...
    fragmentShaderMethodComputation(){
        ...
        ` + 
        this.fragmentShaderMethodComputationOutput();
...
export { OffscreenSurfaceComputationFlow }