...
import { OffscreenSurfaceComputationAll } from "./offscreen_surface_computation_all";
...
class SceneWrapperVisualizationMain extends SceneWrapperVisualization{
    constructor(renderer, scene, camera, controls, raycaster) {
        ...
        this.offscreen_surface_computation = new OffscreenSurfaceComputationAll(renderer, this.simulationParameters, this.marchingCubesMesh);        
    }
    ...
    */
    ...
    updateMarchingCubesMesh(){
        this.marchingCubesMesh.updateMaterial();
