...
export const AppProvider = ({ children }) => {
    const [uiState, setUiState] = useState({
        ...
        UI_STATE_DATA_PHYSICS_SEED_DIRECTION_X: "-0.37164899706840515",
        UI_STATE_DATA_PHYSICS_SEED_DIRECTION_Y: "0.8286622166633606",
        UI_STATE_DATA_PHYSICS_SEED_DIRECTION_Z: "0.4185640811920166",
        UI_STATE_DATA_PHYSICS_SEED_POSITION_X: "-0.02031727507710457",
        UI_STATE_DATA_PHYSICS_SEED_POSITION_Y: "-2.9997153282165527",
        UI_STATE_DATA_PHYSICS_SEED_POSITION_Z: "0.005526777822524309",
        UI_STATE_DATA_INTEGRATION_STEP_SIZE: "0.1",
        UI_STATE_DATA_INTEGRATION_MAX_STEPS: "100",
        UI_STATE_DATA_NUMBER_OF_INTERSECTIONS: "4",
        UI_STATE_DATA_INTEGRATION_BISECTION_STEPS: "8",
        UI_STATE_DATA_DOMAIN_MIN_X: "-4",
        UI_STATE_DATA_DOMAIN_MAX_X: "4",
        UI_STATE_DATA_DOMAIN_PIXELS_X: "200",
        UI_STATE_DATA_DOMAIN_MIN_Y: "-3",
        UI_STATE_DATA_DOMAIN_MAX_Y: "3",
        UI_STATE_DATA_DOMAIN_PIXELS_Y: "150",
        UI_STATE_DATA_DOMAIN_MIN_Z: "-2",
        UI_STATE_DATA_DOMAIN_MAX_Z: "2",
        UI_STATE_DATA_DOMAIN_PIXELS_Z: "100",
        UI_STATE_DATA_FORMULA_SURFACE_IMPLICIT: "x*x/(3.5*3.5) + y*y/(2.5*2.5) + z*z/(1.5*1.5) - 1",
        UI_STATE_DATA_ANGLE_PIXELS_X: "500",
        UI_STATE_DATA_ANGLE_PIXELS_Y: "500",
        UI_STATE_DATA_ANGLE_MIN_X: "0",
        UI_STATE_DATA_ANGLE_MAX_X: "1",
        UI_STATE_DATA_ANGLE_MIN_Y: "0",
        UI_STATE_DATA_ANGLE_MAX_Y: "1",
        ...
        UI_STATE_RENDERING_OPACITY_AUX: "1.0",
        ...
        UI_STATE_RENDERING_TUBE_RADIUS: "0.0075",
